...
{
    public class ObAtm : ScriptInstance
    {
        private Atm io;
        private int ticks;
                ...
                else
                {
                    ...
                    switch (ScriptStage)
                    {
                        case 0:
                            ...
                            if (ticks == 0)
                            {
                                io.DisplayBalance(CitizenFX.Core.Game.Player.Name,
                                    "Account Balance: ",
                                    0);
                                RenderMainPage();
                            }
                        ...
                        case 1:
                            ...
                            //io.SetCursorState(1);
                            io.SetMouseInput(CitizenFX.Core.Game.GetControlNormal(0, Control.CursorX), CitizenFX.Core.Game.GetControlNormal(0, Control.CursorY));
                            ...
                            if (getSelectionTask != null)
                            {
                                if (getSelectionTask.IsCompleted)
                                {
                                    ...
                                    //LogDebug(DisplayedView.ToString());
                                    //LogDebug(SelectedOption.ToString());
                            ...
                            {
                                if (CitizenFX.Core.Game.IsControlJustPressed(0, Control.FrontendAccept) || CitizenFX.Core.Game.IsControlJustPressed(0, Control.Attack))
                                {
                                    io.SetInputSelect();
                                    io.DisplayBalance(CitizenFX.Core.Game.Player.Name,
                                        "Account Balance: ",
                                ...
                                else if (CitizenFX.Core.Game.IsControlJustPressed(0, Control.FrontendUp))
                                {
                                    io.SetInputEvent(1);
                                }
                                else if (CitizenFX.Core.Game.IsControlJustPressed(0, Control.FrontendRight))
                                {
                                    io.SetInputEvent(2);
                                }
                                ...
                                else if (CitizenFX.Core.Game.IsControlJustPressed(0, Control.FrontendLeft))
                                {
                                    io.SetInputEvent(4);
                                }
                            }
        ...
        {
            DisplayedView = 1;
            io.DisplayBalance(CitizenFX.Core.Game.Player.Name, "Account Balance:",
                0);
            io.SetDataSlotEmpty();
            io.SetDataSlot(0, title);
