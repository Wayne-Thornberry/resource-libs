...
namespace Proline.ClassicOnline.EventQueue
{
    ...
    {
        public static void StartComponents(Dictionary<string, ComponentContainer> components)
        { 
            // Init_Session
        ...
        public static Dictionary<string, ComponentContainer> InitializeComponents()
        {
