...
// Building the game here
CakeExecuteScript($"./ext/build.cake",  new CakeSettings(){ Arguments = clientArgs}); // a script should exist here to build and compile all modules into one package  
