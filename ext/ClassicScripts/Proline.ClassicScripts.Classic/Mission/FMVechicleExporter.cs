...
using Proline.ExampleClient.Engine;
using System;
...
namespace Proline.ExampleClient.Scripts.Mission
{
    public class FMVechicleExporter : DemandScript
    {
        ...
        public FMVechicleExporter(string name) : base(name)
        {
