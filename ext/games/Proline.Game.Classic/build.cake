...
var resourceFramework = "Proline.Resource.CGame";
...
Information("Building Engine Components...");

Information("Building Engine Resources...");
CakeExecuteScript($"{resourceDir}/build.cake"); 
...
{ 
    if(resource.ProjectType == 2)
        { 
            var resourceDeployDir = $"{resourceOutputDir}/{resourceFramework}";
