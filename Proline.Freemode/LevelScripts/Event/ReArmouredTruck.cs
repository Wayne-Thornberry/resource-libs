...
namespace Proline.Engine.LevelScripts.Event
{
    public class ReArmouredTruck : GameScript
    {
        ...
        private async Task NotifyPlayer()
        {
            ...
            CitizenFX.Core.Native.API.SetBlipSprite(_truckBlip.Handle, 67);
        ...
        private async Task SpawnArmouredTruckSecurity()
        {
            ...
            while (!CitizenFX.Core.Native.API.NetworkDoesNetworkIdExist(_guardOne.NetworkId) ||
                   !CitizenFX.Core.Native.API.NetworkDoesNetworkIdExist(_guardTwo.NetworkId)) await BaseScript.Delay(0);
        }
        ...
        private async Task SpawnArmouredTruck(PlacePoint place)
        {
            ...
            while (!CitizenFX.Core.Native.API.NetworkDoesNetworkIdExist(_armouredTruck.NetworkId)) await BaseScript.Delay(0);
        }
        ...
        private void SpawnReward()
        {
            ...
            CitizenFX.Core.Native.API.CreateMoneyPickups(cords.X, cords.Y, cords.Z, _rewardMoney, 3, 289396019);
