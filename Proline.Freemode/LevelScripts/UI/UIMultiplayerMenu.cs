...
namespace Proline.Engine.LevelScripts.UI
{
    ...
    public class UIMultiplayerMenu : GameScript
    {
        ...
        public UIMultiplayerMenu() 
        {
            Position = new PointF(50f - (CitizenFX.Core.Native.API.GetSafeZoneSize() - 0.89f) / 0.11f * 78f,
                50f - (CitizenFX.Core.Native.API.GetSafeZoneSize() - 0.89f) / 0.11f * 50f);
