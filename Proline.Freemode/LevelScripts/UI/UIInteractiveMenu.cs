...
namespace Proline.Engine.LevelScripts.UI
{
...
//    {
//        public static List<Menu> Menus { get; public set; } = new List<Menu>();
...
//        public static bool AreMenuButtonsEnabled => Menus.Any((m) => m.Visible) && !Game.IsPaused && CitizenFX.Core.UI.Screen.Fading.IsFadedIn && !API.IsPlayerSwitchInProgress() && !DisableMenuButtons && !Game.Player.IsDead;
...
//                while (!API.HasStreamedTextureDictLoaded(_texture_dict) || !API.HasStreamedTextureDictLoaded("mpleaderboard"))
//                {
//                    await Delay(0);
//                }
//            }
...
//        {
//            if (!Game.IsPaused && !API.IsPauseMenuRestarting() && API.IsScreenFadedIn() && !API.IsPlayerSwitchInProgress() && !Game.Player.IsDead && !DisableMenuButtons)
//            {
//                if (IsAnyMenuOpen())
//                {
...
//                        while ((Game.IsControlPressed(0, Control.InteractionMenu) || Game.IsDisabledControlPressed(0, Control.InteractionMenu)) && !Game.IsPaused && API.IsScreenFadedIn() && !Game.Player.IsDead && !API.IsPlayerSwitchInProgress() && !DontOpenAnyMenu)
//                        {
...
//                    else
//                    {
//                        if ((Game.IsControlJustPressed(0, MenuToggleKey) || Game.IsDisabledControlJustPressed(0, MenuToggleKey)) && !Game.IsPaused && API.IsScreenFadedIn() && !Game.Player.IsDead && !API.IsPlayerSwitchInProgress() && !DontOpenAnyMenu)
//                        {
//                            if (Menus.Count > 0)
//                            {
//                                if (MainMenu != null)
...
//            bool isInputVisible() => API.UpdateOnscreenKeyboard() == 0;
//            if (isInputVisible())
//            {
...
//        {
//            if (Menus.Count > 0 && IsAnyMenuOpen() && !Game.IsPaused && !Game.Player.IsDead && API.IsScreenFadedIn() && !API.IsPlayerSwitchInProgress())
//            {
//                await LoadAssets();
...
//        {
//            if (!Game.IsPaused && !Game.Player.IsDead && API.IsScreenFadedIn() && !API.IsPlayerSwitchInProgress() && !API.IsWarningMessageActive() && API.UpdateOnscreenKeyboard() != 0)
//            {
//                Menu menu = GetCurrentMenu();
...
//                            API.PushScaleformMovieMethodParameterString(button.controlString);
//                            API.PushScaleformMovieMethodParameterString(button.instructionText);
//                            API.EndScaleformMovieMethod();
//                        }
//                    }
...
//                        API.BeginScaleformMovieMethod(_scale, "SET_DATA_SLOT");
//                        API.ScaleformMovieMethodAddParamInt(buttonIndex);
//                        string buttonName = API.GetControlInstructionalButton(0, (int)control, 1);
