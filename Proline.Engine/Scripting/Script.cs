...
{
    internal class Script : EngineObject
    {
        ...
        private Script(string name, string assembly, string classType, ScriptConfig details, int envType = 0) : base("Script")
        {
            //_name = details.Name;
            _assembly = assembly;
            _class = classType;
        ...
        internal static Script CreateNewScript(string name, Assembly assembly, Type type, ScriptConfig details, int envType = 0)
        { 
            return new Script(name, assembly.FullName, type.FullName, details, envType); 
        }
        ...
        internal static void UnregisterScript(Script scriptName)
        {
            var sm = InternalManager.GetInstance();
